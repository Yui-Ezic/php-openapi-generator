 ...
 * 1) Set a break point in PhpCustomGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class PhpCustomGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("php-custom") // use this codegen library
              ...
              .setOutputDir("out/php-custom"); // output directory
